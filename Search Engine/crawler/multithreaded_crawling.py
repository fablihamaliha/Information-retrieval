...
# if there is more than one website there would be more content folders 18,000 links for ryerson
HOMEPAGE = 'https://www.ryerson.ca'
...
def work():
    ...
    while True:
        url = queue.get()
        Crawler.crawl_page(threading.current_thread().name,
                           url)  # SA@@@@@ thread ID
        queue.task_done()
